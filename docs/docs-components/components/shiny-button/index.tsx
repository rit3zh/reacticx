  ...
  return (
    <>
      <style jsx>{`
        ...
        .shiny-cta,
        .shiny-cta-link {
          --shiny-cta-bg: #000000 !important; /* Black background */
          --shiny-cta-bg-subtle: #171717 !important; /* Dark subtle bg */
          --shiny-cta-fg: #ffffff !important; /* White text */
          --shiny-cta-highlight: #ffffff !important; /* White border animation */
          --shiny-cta-highlight-subtle: #d4d4d4 !important; /* Light gray on hover */
