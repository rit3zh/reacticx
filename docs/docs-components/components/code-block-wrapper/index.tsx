...
import {
  ...
  CollapsibleContent,
  CollapsibleTrigger,
} from "@/docs-components/components/collapsable";
import { cn } from "@/lib/utils";

interface CodeBlockProps extends React.ComponentPropsWithoutRef<
  typeof Collapsible
> {
...
export function CodeBlockWrapper({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "absolute flex items-center justify-center bg-gradient-to-b from-fd-background/30 to-fd-background/90 p-2",
